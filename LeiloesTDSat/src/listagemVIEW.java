...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void loadTableData() {
        ...
        List<ProdutosDTO> produtos = produtodao.getAllProdutos();
        
        DefaultTableModel model = new DefaultTableModel(new Object[]{"Nome", "Valor", "Status"}, 0);
        for (ProdutosDTO produto : produtos) {
            model.addRow(new Object[]{produto.getNome(), produto.getValor(), produto.getStatus()});
        }
